...
namespace Engine
{
	...
	enum class OBJ_ID			
	{
		...
		// Jun 3차 이후 추가 ID
		PLAYER_AFTERIMG, EFFECT_SNOW, EFFECT_RAIN,
	...
	enum class STATE_TYPE			{ FRONT_IDLE, FRONT_WALK, FRONT_ROLL, FRONT_ATTACK, FRONT_ATTACK1, FRONT_ATTACK2, FRONT_ATTACK3, FRONT_HIT, FRONT_DIE, FRONT_WAKE, FRONT_SLEEP, FRONT_FLIGHT,
									...
									BOSS_INTRO , BOSS_ENDING, TYPEEND }; // 원하는 상태 있으면 추가
	...
	enum class INTERACTION_TYPE		{ INTERACTION_ALPHA, INTERACTION_ENTER,
		INTERACTION_INSPECT, INTERACTION_CHAT, INTERACTION_QUESTION, TYPEEND };

	enum class UIENTER_TYPE			{ ENTER, INSPECT, CATNAP, BUY, CHAT, QUESTION, TYPEEND };
