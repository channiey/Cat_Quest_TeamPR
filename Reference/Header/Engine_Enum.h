...
namespace Engine
{
	...
	enum class OBJ_ID			
	{
		...
		// BATTLE
		EFFECT_MONSTERSPIRIT, EFFECT_PLAYERSLASH, EFFECT_MOBCUTEFFECT, EFFECT_HEDGEHOG_STEMP,
		...
		//Monster_SKill
		SKILL_MONSTER_FIRE, SKILL_MONSTER_THUNDER, SKILL_MONSTER_ICE, SKILL_MONSTER_BEAM, 
