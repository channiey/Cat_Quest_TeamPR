...
namespace Engine
{
	...
	enum class OBJ_ID			
	{
		...
		// Monster
		 MONSTER_HEDGEHOG, MONSTER_DRAGON, MONSTER_BAT, MONSTER_RAM, MONSTER_FOX, MONSTER_SQUIRREL, MONSTER_WYVERN, MONSTER_WYVERNRED, MONSTER_TEST,
	...
	enum class STATE_TYPE			{ FRONT_IDLE, FRONT_WALK, FRONT_ROLL, FRONT_ATTACK, FRONT_ATTACK1, FRONT_ATTACK2, FRONT_HIT, FRONT_DIE, FRONT_WAKE, FRONT_SLEEP,
									...
									PATROL, CHASE, COMEBACK, MONATTACK, MONREST,BACK_PATROL, BACK_CHASE, BACK_COMEBACK, BACK_MONATTACK, BACK_MONREST, TYPEEND }; // 원하는 상태 있으면 추가
