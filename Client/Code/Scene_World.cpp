...
void CScene_World::LateUpdate_Scene()
{
	...
	CCollisionMgr::GetInstance()->Check_Collision(OBJ_TYPE::PLAYER, OBJ_TYPE::RANGE_OBJ, COL_TYPE::RECT, COL_TYPE::SPHERE);
	CCollisionMgr::GetInstance()->Check_Collision(OBJ_TYPE::MONSTER, OBJ_TYPE::RANGE_OBJ, COL_TYPE::RECT, COL_TYPE::SPHERE);// TODO::최적화 가능
