...
#pragma region Cur State Function
   ...
   // float angle = PI * 2 / numberOfSatellites;
    ...
    {
        CSoundMgr::GetInstance()->PlaySound(L"BallSound.wav", CHANNEL_ID::MONSTER_BOSS_1, SOUND_VOLUME_MONSKILL_THUNDER);
    ...
    {
        CSoundMgr::GetInstance()->PlaySound(L"BallSound.wav", CHANNEL_ID::MONSTER_SERPENT, SOUND_VOLUME_MONSKILL_THUNDER);
...
#pragma endregion
    ...
    {
        CSoundMgr::GetInstance()->PlaySound(L"BulletStopSound2.wav", CHANNEL_ID::MONSTER_FISH, 1.f);
