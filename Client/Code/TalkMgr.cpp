...
#pragma region Quest1 : 대장장이의 부탁
	...
	m_mapTalkData.insert(make_pair(100, vector<wstring>{
		{ L"안녕! 니가 드래곤을 처치하기 위해 \n왔다는 드래곤 블러드구나!"},
		{ L"우리 마을에 잘 왔어!"},
		{ L"드래곤에 대한 정보는 아직 모으고 있는 중이야."},
		{ L"그동안 저 아래쪽에 있는 고슴도치를 \n몇마리 혼내줬으면 좋겠어!"}
		}));
	// 대장장이
...
// Quest3 : 드래곤에게 향하기 위해서
	...
	m_mapTalkData.insert(make_pair(300, vector<wstring>{
		{ L"드래곤이 있는 죽음의섬으로 가기 위해서는 \n비행을 할 수 있어야 합니다."},
		{ L"얼음섬에 살고 있는 마법냥이라면 \n비행에 관련된 기술을 알고 있을 것 같습니다."},
