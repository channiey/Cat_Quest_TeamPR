...
namespace Engine
{
	...
	enum class OBJ_ID			
	{
		...
		//==Skill
		SKILL_PLAYER_FLY, EFFECT_FLYLINGHTING, EFFECT_THORNSPARKLE, EFFECT_THORN_ATTACK,
	...
	enum class STATE_TYPE			{ FRONT_IDLE, FRONT_WALK, FRONT_ROLL, FRONT_ATTACK, FRONT_ATTACK1, FRONT_ATTACK2, FRONT_ATTACK3, FRONT_HIT, FRONT_DIE, FRONT_WAKE, FRONT_SLEEP, FRONT_FLIGHT,
									...
									BOSS_FULLDOWN_FLY, BOSS_FULLDOWN_DOWN, BOSS_CONVERGING_FIRE, TYPEEND }; // 원하는 상태 있으면 추가
